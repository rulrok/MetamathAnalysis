 ...
 * @author Reuel
 */
public class ReachabilityFromEverybodyToAxiomsReverse {
...
//        });
            ...
            ExportMapToTXT.export("reach_distribution_everyone_to_axioms_reverse", calculate, new String[]{"id", "axiom name", "count"});
        }
